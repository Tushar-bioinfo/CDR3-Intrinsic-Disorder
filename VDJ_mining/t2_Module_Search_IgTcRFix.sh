imgtSearch="/work/pi_gblanck/old/old_blanck_group/shared/imgtSearchIgTcr.php"
searchScript="/work/s/st25/my_work/vdj-main/t2_SearchReadsFix.sh"

#Set bin paths
tsv2xlsx="/work/pi_gblanck/old/old_blanck_group/shared/tsv2xlsx.py"
#parallelBin="/home/t/thuda/bin" #notused bc installed personally
#parallel --citation
phpBin="/work/pi_gblanck/old/old_blanck_group/shared/bin/php"
pigz="/work/pi_gblanck/old/old_blanck_group/shared/bin/pigz"
...
resultsDir="/work/s/st25/my_work/vdj-main/BAMs_Results"
echo bamFolder is ${bamFolder}
echo resultsDir is ${resultsDir}
